    ...
    <div className="flex flex-col gap-4 p-4 pt-6">
      <header className="flex items-center justify-between gap-3">
        ...
        {workspaces.length > 1 && (
          <select
            ...
            className="rounded-lg border border-slate-700 bg-surface px-2.5 py-1.5 text-sm text-slate-200"
          >
            {workspaces.map((item) => (
      ...
      {spending.length > 0 && (
        <section className="rounded-2xl border border-slate-700 bg-surface p-4">
          <h2 className="mb-3 text-sm font-medium text-slate-300">Spending by category</h2>
                ...
                <div className="h-1.5 overflow-hidden rounded-full bg-slate-800">
                  <div
                    ...
                    style={{
                      ...
                      backgroundColor: row.category_color || '#2dd4bf',
                    }}
                  />
                </div>
              </li>
